<template>
  ...
  >
    ...
    <div
      class="content"
      id="content"
      :class="{'constant-height': isShowRule}"
    >
      ...
      <div
        class="coupon-rule-detail"
        id="activity"
      >
        <p>1、优惠活动期内，银联卡（卡号以62开头）持卡人在莎莎香港及澳门门店消费单笔购物金额满港币或澳门币100元或以上，经验证以二维码或条形码为形式的莎莎电子现金券后使用银联卡支付，立减港币或澳门币30元；</p>
    ...
    <div class="coupon-show-more" @click='showMore'>
        <div class="show-more-mask" id="show-more-mask" :class="{'dis-block': isShowRule, 'dis-none': !isShowRule}"></div>
        <div class="show-more-btn" id="show-more-btn" :class="{'flex-down': isShowRule, 'flex-up': !isShowRule}">
            <span>查看详情</span>
        </div>
    </div>
  </div>
...
export default class CouponRule extends Vue {
    private isShowRule: boolean = true
    private columnName: string = '优惠券详情'
