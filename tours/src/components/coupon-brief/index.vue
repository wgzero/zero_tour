  ...
  <div class="coupon-top-wraper">
      ...
      <div class="coupon-brief">
          <div class="coupon-ico">
              <img :src="coupon.coupon_ico_path" width="79" height="79" alt="">
          </div>
...
// component 组件定义 可以放过滤器
@Component({
   
    filters: {
			dateFormate (timestamp: string): string | number {
...
export default class CouponBrief extends Vue {
    @Prop({type: Object}) private coupon!: CouponInterface
}
</script>
...
.coupon-top-wraper{
    ...
    .top-ico{
        ...
        .union-ico{
            ...
            background-image: url('http://wgzero.com/static/img/quan_banklogo.png');
        ...
        .hq-ico{
            ...
            background-image: url('http://wgzero.com/static/img/quan_logo.png');
